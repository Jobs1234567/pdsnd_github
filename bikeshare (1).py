...
def get_filters():
    ...
    print("Type end ,guy, you would like to exit the program.\n")
...
def user_stats(df, city):
    ...
    try:
        ...
        print("So sorry! There is no data of birth year for {}."
              .format(city.title()))
